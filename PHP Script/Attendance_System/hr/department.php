    ...
    <div class="table-wrapper">
                  ...
                  <tr>
                    ...
                    <td><?php echo($department['username']); ?></td>
                     <td>
                      ...
                      <button onclick="openEdit(<?php echo($department['department_id']); ?>, '<?php echo($department['department_name']); ?>', '<?php echo($department['user_id']); ?>')" class="btn edit">Edit</button>
                    


                      <a href="delete_department.php?dep_id=<?php echo($department['department_id']); ?>"><button class="btn delete">Delete</button></a>
                     </td>
                  </tr>
                <?php endforeach; ?>
              </tbody>
      ...
      <div class="form-popup" id="CreateForm">
        <h1>Create New Department</h1>
          <form method="POST" action="create_department.php" class="form-container">
                  <label for="department_id">Department ID:</label>
                  <input type="number" name="department_id" id="department_id" name="department_id" placeholder="Enter the Department ID" required> 
      ...
      <div class="form-popup" id="EditForm">
        <h1 ><span id="dep_name"></span></h1> 
          <form method="POST" action="edit_department.php" class="form-container">

                  <input type="number" name="e_department_id" hidden>
                  <input type="hidden" name="before_e_department_name" hidden>
                  <input type="hidden" name="before_e_manager_id" hidden>

                  <label for="e_department_name">Department Name:</label>              
                  <input type="text" name="e_department_name" placeholder="Enter the Department Name">       
      ...
      <div class="form-popup" id="PasswordEditForm">
        ...
        <h1>Change Password</h1>
          <form method="POST" action="edit_profile.php" class="form-container">
              ...
              <input type="hidden" name="file" value="department.php" hidden>
...
<script type="text/javascript">
  ...
  function openEdit(dep_id,dep_name,manager_id) {

    document.getElementsByName("e_department_id")[0].value = dep_id;
    document.getElementsByName("before_e_department_name")[0].value = dep_name;
    document.getElementsByName("before_e_manager_id")[0].value = manager_id;

    document.getElementsByName("e_department_name")[0].value = dep_name;
    document.querySelector("select[name='manager_name']").value = manager_id;
    // document.querySelector("select[name='manager_name']").value = manager_id;
    document.getElementById("dep_name").innerHTML = 'Edit Department : '+dep_name;
